...
import no.nav.omsorgsdagermeldingapi.general.oppslag.throwable
...
class BarnGateway (
    ...
    override suspend fun check(): Result { //TODO Trekke ut til en felles, trenger vi dobbel helsesjekk?
